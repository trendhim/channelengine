...
type ChannelOrderLineResponse struct {
	...
	// Exact delivery date from channels, empty if channels not support this value
	...
	// Latest delivery date from channels, empty if channels not support this value
	LatestDeliveryDate NullableTime `json:"LatestDeliveryDate,omitempty"`
	// Expected shipment date from channels, empty if channels not support this value
	ExpectedShipmentDate NullableTime `json:"ExpectedShipmentDate,omitempty"`
	// Latest shipment date from channels, empty if channels not support this value
