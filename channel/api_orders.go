...
type OrdersAPIOrderCreateRequest struct {
	ctx context.Context
	ApiService *OrdersAPIService
	channelOrderRequest *ChannelOrderRequest
}

func (r OrdersAPIOrderCreateRequest) ChannelOrderRequest(channelOrderRequest ChannelOrderRequest) OrdersAPIOrderCreateRequest {
	r.channelOrderRequest = &channelOrderRequest
	return r
}

func (r OrdersAPIOrderCreateRequest) Execute() (*ApiResponse, *http.Response, error) {
...
Create a new order in ChannelEngine.
 ...
 @return OrdersAPIOrderCreateRequest
*/
func (a *OrdersAPIService) OrderCreate(ctx context.Context) OrdersAPIOrderCreateRequest {
	return OrdersAPIOrderCreateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return ApiResponse
func (a *OrdersAPIService) OrderCreateExecute(r OrdersAPIOrderCreateRequest) (*ApiResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrdersAPIService.OrderCreate")
	if err != nil {
