...
// checks if the CollectionOfChannelOfferResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionOfChannelOfferResponse{}

// CollectionOfChannelOfferResponse struct for CollectionOfChannelOfferResponse
type CollectionOfChannelOfferResponse struct {
	Content []ChannelOfferResponse `json:"Content,omitempty"`
...
func NewCollectionOfChannelOfferResponse() *CollectionOfChannelOfferResponse {
	this := CollectionOfChannelOfferResponse{}
	return &this
}
...
// SetContent gets a reference to the given []ChannelOfferResponse and assigns it to the Content field.
...
func (o *CollectionOfChannelOfferResponse) SetRequestIdNil() {
	o.RequestId.Set(nil)
}
...
func (o *CollectionOfChannelOfferResponse) SetLogIdNil() {
	o.LogId.Set(nil)
}
...
func (o *CollectionOfChannelOfferResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o *CollectionOfChannelOfferResponse) SetExceptionTypeNil() {
...
func (o CollectionOfChannelOfferResponse) MarshalJSON() ([]byte, error) {
...
func (o CollectionOfChannelOfferResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionOfChannelOfferResponse struct {
	value *CollectionOfChannelOfferResponse
	isSet bool
}

func (v NullableCollectionOfChannelOfferResponse) Get() *CollectionOfChannelOfferResponse {
	return v.value
}

func (v *NullableCollectionOfChannelOfferResponse) Set(val *CollectionOfChannelOfferResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionOfChannelOfferResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionOfChannelOfferResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionOfChannelOfferResponse(val *CollectionOfChannelOfferResponse) *NullableCollectionOfChannelOfferResponse {
	return &NullableCollectionOfChannelOfferResponse{value: val, isSet: true}
}

func (v NullableCollectionOfChannelOfferResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionOfChannelOfferResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
