...
// checks if the CollectionOfMerchantReturnResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionOfMerchantReturnResponse{}

// CollectionOfMerchantReturnResponse struct for CollectionOfMerchantReturnResponse
type CollectionOfMerchantReturnResponse struct {
	Content []MerchantReturnResponse `json:"Content,omitempty"`
...
func NewCollectionOfMerchantReturnResponse() *CollectionOfMerchantReturnResponse {
	this := CollectionOfMerchantReturnResponse{}
	return &this
}
...
func (o *CollectionOfMerchantReturnResponse) GetContent() []MerchantReturnResponse {
	if o == nil {
		var ret []MerchantReturnResponse
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []MerchantReturnResponse and assigns it to the Content field.
...
func (o *CollectionOfMerchantReturnResponse) SetRequestIdNil() {
	o.RequestId.Set(nil)
}
...
func (o *CollectionOfMerchantReturnResponse) SetLogIdNil() {
	o.LogId.Set(nil)
}
...
func (o *CollectionOfMerchantReturnResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o *CollectionOfMerchantReturnResponse) SetExceptionTypeNil() {
...
func (o CollectionOfMerchantReturnResponse) MarshalJSON() ([]byte, error) {
...
func (o CollectionOfMerchantReturnResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionOfMerchantReturnResponse struct {
	value *CollectionOfMerchantReturnResponse
	isSet bool
}

func (v NullableCollectionOfMerchantReturnResponse) Get() *CollectionOfMerchantReturnResponse {
	return v.value
}

func (v *NullableCollectionOfMerchantReturnResponse) Set(val *CollectionOfMerchantReturnResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionOfMerchantReturnResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionOfMerchantReturnResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionOfMerchantReturnResponse(val *CollectionOfMerchantReturnResponse) *NullableCollectionOfMerchantReturnResponse {
	return &NullableCollectionOfMerchantReturnResponse{value: val, isSet: true}
}

func (v NullableCollectionOfMerchantReturnResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionOfMerchantReturnResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
