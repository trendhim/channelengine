...
// checks if the CollectionOfCustomFieldResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionOfCustomFieldResponse{}

// CollectionOfCustomFieldResponse struct for CollectionOfCustomFieldResponse
type CollectionOfCustomFieldResponse struct {
	Content []CustomFieldResponse `json:"Content,omitempty"`
...
func NewCollectionOfCustomFieldResponse() *CollectionOfCustomFieldResponse {
	this := CollectionOfCustomFieldResponse{}
	return &this
}
...
// SetContent gets a reference to the given []CustomFieldResponse and assigns it to the Content field.
...
func (o *CollectionOfCustomFieldResponse) SetRequestIdNil() {
	o.RequestId.Set(nil)
}
...
func (o *CollectionOfCustomFieldResponse) SetLogIdNil() {
	o.LogId.Set(nil)
}
...
func (o *CollectionOfCustomFieldResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o *CollectionOfCustomFieldResponse) SetExceptionTypeNil() {
...
func (o CollectionOfCustomFieldResponse) MarshalJSON() ([]byte, error) {
...
func (o CollectionOfCustomFieldResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionOfCustomFieldResponse struct {
	value *CollectionOfCustomFieldResponse
	isSet bool
}

func (v NullableCollectionOfCustomFieldResponse) Get() *CollectionOfCustomFieldResponse {
	return v.value
}

func (v *NullableCollectionOfCustomFieldResponse) Set(val *CollectionOfCustomFieldResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionOfCustomFieldResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionOfCustomFieldResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionOfCustomFieldResponse(val *CollectionOfCustomFieldResponse) *NullableCollectionOfCustomFieldResponse {
	return &NullableCollectionOfCustomFieldResponse{value: val, isSet: true}
}

func (v NullableCollectionOfCustomFieldResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionOfCustomFieldResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
