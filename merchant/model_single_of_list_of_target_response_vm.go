...
// checks if the SingleOfListOfTargetResponseVm type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SingleOfListOfTargetResponseVm{}

// SingleOfListOfTargetResponseVm struct for SingleOfListOfTargetResponseVm
type SingleOfListOfTargetResponseVm struct {
	Content []TargetResponseVm `json:"Content,omitempty"`
...
func NewSingleOfListOfTargetResponseVm() *SingleOfListOfTargetResponseVm {
	this := SingleOfListOfTargetResponseVm{}
	return &this
}
...
// SetContent gets a reference to the given []TargetResponseVm and assigns it to the Content field.
...
func (o *SingleOfListOfTargetResponseVm) SetRequestIdNil() {
	o.RequestId.Set(nil)
}
...
func (o *SingleOfListOfTargetResponseVm) SetLogIdNil() {
	o.LogId.Set(nil)
}
...
func (o *SingleOfListOfTargetResponseVm) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o *SingleOfListOfTargetResponseVm) SetExceptionTypeNil() {
...
func (o SingleOfListOfTargetResponseVm) MarshalJSON() ([]byte, error) {
...
func (o SingleOfListOfTargetResponseVm) ToMap() (map[string]interface{}, error) {
...
type NullableSingleOfListOfTargetResponseVm struct {
	value *SingleOfListOfTargetResponseVm
	isSet bool
}

func (v NullableSingleOfListOfTargetResponseVm) Get() *SingleOfListOfTargetResponseVm {
	return v.value
}

func (v *NullableSingleOfListOfTargetResponseVm) Set(val *SingleOfListOfTargetResponseVm) {
	v.value = val
	v.isSet = true
}

func (v NullableSingleOfListOfTargetResponseVm) IsSet() bool {
	return v.isSet
}

func (v *NullableSingleOfListOfTargetResponseVm) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSingleOfListOfTargetResponseVm(val *SingleOfListOfTargetResponseVm) *NullableSingleOfListOfTargetResponseVm {
	return &NullableSingleOfListOfTargetResponseVm{value: val, isSet: true}
}

func (v NullableSingleOfListOfTargetResponseVm) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSingleOfListOfTargetResponseVm) UnmarshalJSON(src []byte) error {
	v.isSet = true
