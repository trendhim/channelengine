...
// checks if the CollectionOfMerchantShipmentLabelCarrierResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionOfMerchantShipmentLabelCarrierResponse{}

// CollectionOfMerchantShipmentLabelCarrierResponse struct for CollectionOfMerchantShipmentLabelCarrierResponse
type CollectionOfMerchantShipmentLabelCarrierResponse struct {
	Content []MerchantShipmentLabelCarrierResponse `json:"Content,omitempty"`
...
func NewCollectionOfMerchantShipmentLabelCarrierResponse() *CollectionOfMerchantShipmentLabelCarrierResponse {
	this := CollectionOfMerchantShipmentLabelCarrierResponse{}
	return &this
}
...
func (o *CollectionOfMerchantShipmentLabelCarrierResponse) GetContent() []MerchantShipmentLabelCarrierResponse {
	if o == nil {
		var ret []MerchantShipmentLabelCarrierResponse
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []MerchantShipmentLabelCarrierResponse and assigns it to the Content field.
...
func (o *CollectionOfMerchantShipmentLabelCarrierResponse) SetRequestIdNil() {
	o.RequestId.Set(nil)
}
...
func (o *CollectionOfMerchantShipmentLabelCarrierResponse) SetLogIdNil() {
	o.LogId.Set(nil)
}
...
func (o *CollectionOfMerchantShipmentLabelCarrierResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o *CollectionOfMerchantShipmentLabelCarrierResponse) SetExceptionTypeNil() {
...
func (o CollectionOfMerchantShipmentLabelCarrierResponse) MarshalJSON() ([]byte, error) {
...
func (o CollectionOfMerchantShipmentLabelCarrierResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionOfMerchantShipmentLabelCarrierResponse struct {
	value *CollectionOfMerchantShipmentLabelCarrierResponse
	isSet bool
}

func (v NullableCollectionOfMerchantShipmentLabelCarrierResponse) Get() *CollectionOfMerchantShipmentLabelCarrierResponse {
	return v.value
}

func (v *NullableCollectionOfMerchantShipmentLabelCarrierResponse) Set(val *CollectionOfMerchantShipmentLabelCarrierResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionOfMerchantShipmentLabelCarrierResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionOfMerchantShipmentLabelCarrierResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionOfMerchantShipmentLabelCarrierResponse(val *CollectionOfMerchantShipmentLabelCarrierResponse) *NullableCollectionOfMerchantShipmentLabelCarrierResponse {
	return &NullableCollectionOfMerchantShipmentLabelCarrierResponse{value: val, isSet: true}
}

func (v NullableCollectionOfMerchantShipmentLabelCarrierResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionOfMerchantShipmentLabelCarrierResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
