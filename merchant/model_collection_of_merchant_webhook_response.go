...
// checks if the CollectionOfMerchantWebhookResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionOfMerchantWebhookResponse{}

// CollectionOfMerchantWebhookResponse struct for CollectionOfMerchantWebhookResponse
type CollectionOfMerchantWebhookResponse struct {
	Content []MerchantWebhookResponse `json:"Content,omitempty"`
...
func NewCollectionOfMerchantWebhookResponse() *CollectionOfMerchantWebhookResponse {
	this := CollectionOfMerchantWebhookResponse{}
	return &this
}
...
func (o *CollectionOfMerchantWebhookResponse) GetContent() []MerchantWebhookResponse {
	if o == nil {
		var ret []MerchantWebhookResponse
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []MerchantWebhookResponse and assigns it to the Content field.
...
func (o *CollectionOfMerchantWebhookResponse) SetRequestIdNil() {
	o.RequestId.Set(nil)
}
...
func (o *CollectionOfMerchantWebhookResponse) SetLogIdNil() {
	o.LogId.Set(nil)
}
...
func (o *CollectionOfMerchantWebhookResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o *CollectionOfMerchantWebhookResponse) SetExceptionTypeNil() {
...
func (o CollectionOfMerchantWebhookResponse) MarshalJSON() ([]byte, error) {
...
func (o CollectionOfMerchantWebhookResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionOfMerchantWebhookResponse struct {
	value *CollectionOfMerchantWebhookResponse
	isSet bool
}

func (v NullableCollectionOfMerchantWebhookResponse) Get() *CollectionOfMerchantWebhookResponse {
	return v.value
}

func (v *NullableCollectionOfMerchantWebhookResponse) Set(val *CollectionOfMerchantWebhookResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionOfMerchantWebhookResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionOfMerchantWebhookResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionOfMerchantWebhookResponse(val *CollectionOfMerchantWebhookResponse) *NullableCollectionOfMerchantWebhookResponse {
	return &NullableCollectionOfMerchantWebhookResponse{value: val, isSet: true}
}

func (v NullableCollectionOfMerchantWebhookResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionOfMerchantWebhookResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
