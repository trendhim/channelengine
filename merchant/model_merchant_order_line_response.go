...
type MerchantOrderLineResponse struct {
	...
	// The order line reference used by the channel.
...
func (o *MerchantOrderLineResponse) SetChannelOrderLineNoNil() {
...
func (o *MerchantOrderLineResponse) SetExactDeliveryDateNil() {
...
func (o *MerchantOrderLineResponse) SetLatestDeliveryDateNil() {
...
func (o *MerchantOrderLineResponse) SetExactShipmentDateNil() {
...
func (o *MerchantOrderLineResponse) SetExpectedShipmentDateNil() {
...
func (o *MerchantOrderLineResponse) SetLatestShipmentDateNil() {
...
func (o *MerchantOrderLineResponse) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varMerchantOrderLineResponse)
