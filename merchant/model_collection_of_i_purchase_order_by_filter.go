...
// checks if the CollectionOfIPurchaseOrderByFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionOfIPurchaseOrderByFilter{}

// CollectionOfIPurchaseOrderByFilter struct for CollectionOfIPurchaseOrderByFilter
type CollectionOfIPurchaseOrderByFilter struct {
	Content []IPurchaseOrderByFilter `json:"Content,omitempty"`
...
func NewCollectionOfIPurchaseOrderByFilter() *CollectionOfIPurchaseOrderByFilter {
	this := CollectionOfIPurchaseOrderByFilter{}
	return &this
}
...
func (o *CollectionOfIPurchaseOrderByFilter) GetContent() []IPurchaseOrderByFilter {
	if o == nil {
		var ret []IPurchaseOrderByFilter
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []IPurchaseOrderByFilter and assigns it to the Content field.
...
func (o *CollectionOfIPurchaseOrderByFilter) SetRequestIdNil() {
	o.RequestId.Set(nil)
}
...
func (o *CollectionOfIPurchaseOrderByFilter) SetLogIdNil() {
	o.LogId.Set(nil)
}
...
func (o *CollectionOfIPurchaseOrderByFilter) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o *CollectionOfIPurchaseOrderByFilter) SetExceptionTypeNil() {
...
func (o CollectionOfIPurchaseOrderByFilter) MarshalJSON() ([]byte, error) {
...
func (o CollectionOfIPurchaseOrderByFilter) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionOfIPurchaseOrderByFilter struct {
	value *CollectionOfIPurchaseOrderByFilter
	isSet bool
}

func (v NullableCollectionOfIPurchaseOrderByFilter) Get() *CollectionOfIPurchaseOrderByFilter {
	return v.value
}

func (v *NullableCollectionOfIPurchaseOrderByFilter) Set(val *CollectionOfIPurchaseOrderByFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionOfIPurchaseOrderByFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionOfIPurchaseOrderByFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionOfIPurchaseOrderByFilter(val *CollectionOfIPurchaseOrderByFilter) *NullableCollectionOfIPurchaseOrderByFilter {
	return &NullableCollectionOfIPurchaseOrderByFilter{value: val, isSet: true}
}

func (v NullableCollectionOfIPurchaseOrderByFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionOfIPurchaseOrderByFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
