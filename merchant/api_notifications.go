...
type NotificationsAPINotificationIndexRequest struct {
	ctx context.Context
...
func (r NotificationsAPINotificationIndexRequest) FromDate(fromDate time.Time) NotificationsAPINotificationIndexRequest {
	r.fromDate = &fromDate
	return r
}

// Filter on the notification date, until this date. This date is exclusive.
func (r NotificationsAPINotificationIndexRequest) ToDate(toDate time.Time) NotificationsAPINotificationIndexRequest {
	r.toDate = &toDate
	return r
}

// Notification type(s) to filter on.
func (r NotificationsAPINotificationIndexRequest) Types(types []NotificationType) NotificationsAPINotificationIndexRequest {
	r.types = &types
	return r
}

// Filter on unique order reference used by the merchant.
func (r NotificationsAPINotificationIndexRequest) MerchantOrderNos(merchantOrderNos []string) NotificationsAPINotificationIndexRequest {
	r.merchantOrderNos = &merchantOrderNos
	return r
}

// Filter on unique order reference used by the channel.
func (r NotificationsAPINotificationIndexRequest) ChannelOrderNos(channelOrderNos []string) NotificationsAPINotificationIndexRequest {
	r.channelOrderNos = &channelOrderNos
	return r
}

// Filter on unique return reference used by the merchant.
func (r NotificationsAPINotificationIndexRequest) MerchantReturnNos(merchantReturnNos []string) NotificationsAPINotificationIndexRequest {
	r.merchantReturnNos = &merchantReturnNos
	return r
}

// Filter on unique return reference used by the channel.
func (r NotificationsAPINotificationIndexRequest) ChannelReturnNos(channelReturnNos []string) NotificationsAPINotificationIndexRequest {
	r.channelReturnNos = &channelReturnNos
	return r
}

// Filter on unique shipment reference used by the merchant.
func (r NotificationsAPINotificationIndexRequest) MerchantShipmentNos(merchantShipmentNos []string) NotificationsAPINotificationIndexRequest {
	r.merchantShipmentNos = &merchantShipmentNos
	return r
}

// The page to filter on. Starts at 1.
func (r NotificationsAPINotificationIndexRequest) Page(page int32) NotificationsAPINotificationIndexRequest {
	r.page = &page
	return r
}

func (r NotificationsAPINotificationIndexRequest) Execute() (*CollectionOfMerchantNotificationResponse, *http.Response, error) {
...
Gets ChannelEngine notifications based on the available filters.
 ...
 @return NotificationsAPINotificationIndexRequest
*/
func (a *NotificationsAPIService) NotificationIndex(ctx context.Context) NotificationsAPINotificationIndexRequest {
	return NotificationsAPINotificationIndexRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *NotificationsAPIService) NotificationIndexExecute(r NotificationsAPINotificationIndexRequest) (*CollectionOfMerchantNotificationResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NotificationsAPIService.NotificationIndex")
	if err != nil {
