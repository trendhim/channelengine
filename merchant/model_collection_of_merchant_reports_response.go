...
// checks if the CollectionOfMerchantReportsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionOfMerchantReportsResponse{}

// CollectionOfMerchantReportsResponse struct for CollectionOfMerchantReportsResponse
type CollectionOfMerchantReportsResponse struct {
	Content []MerchantReportsResponse `json:"Content,omitempty"`
...
func NewCollectionOfMerchantReportsResponse() *CollectionOfMerchantReportsResponse {
	this := CollectionOfMerchantReportsResponse{}
	return &this
}
...
func (o *CollectionOfMerchantReportsResponse) GetContent() []MerchantReportsResponse {
	if o == nil {
		var ret []MerchantReportsResponse
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []MerchantReportsResponse and assigns it to the Content field.
...
func (o *CollectionOfMerchantReportsResponse) SetRequestIdNil() {
	o.RequestId.Set(nil)
}
...
func (o *CollectionOfMerchantReportsResponse) SetLogIdNil() {
	o.LogId.Set(nil)
}
...
func (o *CollectionOfMerchantReportsResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o CollectionOfMerchantReportsResponse) MarshalJSON() ([]byte, error) {
...
func (o CollectionOfMerchantReportsResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionOfMerchantReportsResponse struct {
	value *CollectionOfMerchantReportsResponse
	isSet bool
}

func (v NullableCollectionOfMerchantReportsResponse) Get() *CollectionOfMerchantReportsResponse {
	return v.value
}

func (v *NullableCollectionOfMerchantReportsResponse) Set(val *CollectionOfMerchantReportsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionOfMerchantReportsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionOfMerchantReportsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionOfMerchantReportsResponse(val *CollectionOfMerchantReportsResponse) *NullableCollectionOfMerchantReportsResponse {
	return &NullableCollectionOfMerchantReportsResponse{value: val, isSet: true}
}

func (v NullableCollectionOfMerchantReportsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionOfMerchantReportsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
