...
// checks if the CollectionOfChannelGlobalChannelResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionOfChannelGlobalChannelResponse{}

// CollectionOfChannelGlobalChannelResponse struct for CollectionOfChannelGlobalChannelResponse
type CollectionOfChannelGlobalChannelResponse struct {
	Content []ChannelGlobalChannelResponse `json:"Content,omitempty"`
...
func NewCollectionOfChannelGlobalChannelResponse() *CollectionOfChannelGlobalChannelResponse {
	this := CollectionOfChannelGlobalChannelResponse{}
	return &this
}
...
func (o *CollectionOfChannelGlobalChannelResponse) GetContent() []ChannelGlobalChannelResponse {
	if o == nil {
		var ret []ChannelGlobalChannelResponse
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []ChannelGlobalChannelResponse and assigns it to the Content field.
...
func (o *CollectionOfChannelGlobalChannelResponse) SetRequestIdNil() {
	o.RequestId.Set(nil)
}
...
func (o *CollectionOfChannelGlobalChannelResponse) SetLogIdNil() {
	o.LogId.Set(nil)
}
...
func (o *CollectionOfChannelGlobalChannelResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o *CollectionOfChannelGlobalChannelResponse) SetExceptionTypeNil() {
...
func (o CollectionOfChannelGlobalChannelResponse) MarshalJSON() ([]byte, error) {
...
func (o CollectionOfChannelGlobalChannelResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionOfChannelGlobalChannelResponse struct {
	value *CollectionOfChannelGlobalChannelResponse
	isSet bool
}

func (v NullableCollectionOfChannelGlobalChannelResponse) Get() *CollectionOfChannelGlobalChannelResponse {
	return v.value
}

func (v *NullableCollectionOfChannelGlobalChannelResponse) Set(val *CollectionOfChannelGlobalChannelResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionOfChannelGlobalChannelResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionOfChannelGlobalChannelResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionOfChannelGlobalChannelResponse(val *CollectionOfChannelGlobalChannelResponse) *NullableCollectionOfChannelGlobalChannelResponse {
	return &NullableCollectionOfChannelGlobalChannelResponse{value: val, isSet: true}
}

func (v NullableCollectionOfChannelGlobalChannelResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionOfChannelGlobalChannelResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
