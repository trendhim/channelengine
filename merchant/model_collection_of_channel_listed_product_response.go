...
// checks if the CollectionOfChannelListedProductResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionOfChannelListedProductResponse{}

// CollectionOfChannelListedProductResponse struct for CollectionOfChannelListedProductResponse
type CollectionOfChannelListedProductResponse struct {
	Content []ChannelListedProductResponse `json:"Content,omitempty"`
...
func NewCollectionOfChannelListedProductResponse() *CollectionOfChannelListedProductResponse {
	this := CollectionOfChannelListedProductResponse{}
	return &this
}
...
func (o *CollectionOfChannelListedProductResponse) GetContent() []ChannelListedProductResponse {
	if o == nil {
		var ret []ChannelListedProductResponse
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []ChannelListedProductResponse and assigns it to the Content field.
...
func (o *CollectionOfChannelListedProductResponse) SetRequestIdNil() {
	o.RequestId.Set(nil)
}
...
func (o *CollectionOfChannelListedProductResponse) SetLogIdNil() {
	o.LogId.Set(nil)
}
...
func (o *CollectionOfChannelListedProductResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o *CollectionOfChannelListedProductResponse) SetExceptionTypeNil() {
...
func (o CollectionOfChannelListedProductResponse) MarshalJSON() ([]byte, error) {
...
func (o CollectionOfChannelListedProductResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionOfChannelListedProductResponse struct {
	value *CollectionOfChannelListedProductResponse
	isSet bool
}

func (v NullableCollectionOfChannelListedProductResponse) Get() *CollectionOfChannelListedProductResponse {
	return v.value
}

func (v *NullableCollectionOfChannelListedProductResponse) Set(val *CollectionOfChannelListedProductResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionOfChannelListedProductResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionOfChannelListedProductResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionOfChannelListedProductResponse(val *CollectionOfChannelListedProductResponse) *NullableCollectionOfChannelListedProductResponse {
	return &NullableCollectionOfChannelListedProductResponse{value: val, isSet: true}
}

func (v NullableCollectionOfChannelListedProductResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionOfChannelListedProductResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
