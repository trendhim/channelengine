...
// checks if the CreateEditTargetRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateEditTargetRequest{}

// CreateEditTargetRequest struct for CreateEditTargetRequest
type CreateEditTargetRequest struct {
	ChannelId NullableInt32 `json:"ChannelId,omitempty"`
	Targets []CreateEditTargetView `json:"Targets,omitempty"`
}
...
func (o *CreateEditTargetRequest) SetChannelIdNil() {
	o.ChannelId.Set(nil)
}
...
// SetTargets gets a reference to the given []CreateEditTargetView and assigns it to the Targets field.
func (o *CreateEditTargetRequest) SetTargets(v []CreateEditTargetView) {
	o.Targets = v
}

func (o CreateEditTargetRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateEditTargetRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateEditTargetRequest struct {
	value *CreateEditTargetRequest
	isSet bool
}

func (v NullableCreateEditTargetRequest) Get() *CreateEditTargetRequest {
	return v.value
}

func (v *NullableCreateEditTargetRequest) Set(val *CreateEditTargetRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateEditTargetRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateEditTargetRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateEditTargetRequest(val *CreateEditTargetRequest) *NullableCreateEditTargetRequest {
	return &NullableCreateEditTargetRequest{value: val, isSet: true}
}

func (v NullableCreateEditTargetRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateEditTargetRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
