...
type MerchantSettlementReportsResponse struct {
	...
	CurrentReserveAmount NullableFloat32 `json:"CurrentReserveAmount,omitempty"`
	PreviousReserveAmount NullableFloat32 `json:"PreviousReserveAmount,omitempty"`
	PaymentAmount NullableFloat32 `json:"PaymentAmount,omitempty"`
}
...
// GetCurrentReserveAmount returns the CurrentReserveAmount field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *MerchantSettlementReportsResponse) GetCurrentReserveAmount() float32 {
	if o == nil || IsNil(o.CurrentReserveAmount.Get()) {
		var ret float32
		return ret
	}
	return *o.CurrentReserveAmount.Get()
}

// GetCurrentReserveAmountOk returns a tuple with the CurrentReserveAmount field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *MerchantSettlementReportsResponse) GetCurrentReserveAmountOk() (*float32, bool) {
	...
	return o.CurrentReserveAmount.Get(), o.CurrentReserveAmount.IsSet()
}
...
func (o *MerchantSettlementReportsResponse) HasCurrentReserveAmount() bool {
	if o != nil && o.CurrentReserveAmount.IsSet() {
		return true
	}
...
// SetCurrentReserveAmount gets a reference to the given NullableFloat32 and assigns it to the CurrentReserveAmount field.
func (o *MerchantSettlementReportsResponse) SetCurrentReserveAmount(v float32) {
	o.CurrentReserveAmount.Set(&v)
}
// SetCurrentReserveAmountNil sets the value for CurrentReserveAmount to be an explicit nil
func (o *MerchantSettlementReportsResponse) SetCurrentReserveAmountNil() {
	o.CurrentReserveAmount.Set(nil)
}
...
func (o *MerchantSettlementReportsResponse) UnsetCurrentReserveAmount() {
	o.CurrentReserveAmount.Unset()
}

// GetPreviousReserveAmount returns the PreviousReserveAmount field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *MerchantSettlementReportsResponse) GetPreviousReserveAmount() float32 {
	if o == nil || IsNil(o.PreviousReserveAmount.Get()) {
		var ret float32
		return ret
	}
	return *o.PreviousReserveAmount.Get()
}

// GetPreviousReserveAmountOk returns a tuple with the PreviousReserveAmount field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *MerchantSettlementReportsResponse) GetPreviousReserveAmountOk() (*float32, bool) {
	...
	return o.PreviousReserveAmount.Get(), o.PreviousReserveAmount.IsSet()
}
...
func (o *MerchantSettlementReportsResponse) HasPreviousReserveAmount() bool {
	if o != nil && o.PreviousReserveAmount.IsSet() {
		return true
	}
...
// SetPreviousReserveAmount gets a reference to the given NullableFloat32 and assigns it to the PreviousReserveAmount field.
func (o *MerchantSettlementReportsResponse) SetPreviousReserveAmount(v float32) {
	o.PreviousReserveAmount.Set(&v)
}
// SetPreviousReserveAmountNil sets the value for PreviousReserveAmount to be an explicit nil
func (o *MerchantSettlementReportsResponse) SetPreviousReserveAmountNil() {
	o.PreviousReserveAmount.Set(nil)
}
...
func (o *MerchantSettlementReportsResponse) SetPaymentAmountNil() {
...
func (o MerchantSettlementReportsResponse) ToMap() (map[string]interface{}, error) {
	...
	if o.CurrentReserveAmount.IsSet() {
		toSerialize["CurrentReserveAmount"] = o.CurrentReserveAmount.Get()
	}
	if o.PreviousReserveAmount.IsSet() {
		toSerialize["PreviousReserveAmount"] = o.PreviousReserveAmount.Get()
	}
