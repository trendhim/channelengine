...
// checks if the CollectionOfMerchantOrderResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionOfMerchantOrderResponse{}

// CollectionOfMerchantOrderResponse struct for CollectionOfMerchantOrderResponse
type CollectionOfMerchantOrderResponse struct {
	Content []MerchantOrderResponse `json:"Content,omitempty"`
...
func NewCollectionOfMerchantOrderResponse() *CollectionOfMerchantOrderResponse {
	this := CollectionOfMerchantOrderResponse{}
	return &this
}
...
// SetContent gets a reference to the given []MerchantOrderResponse and assigns it to the Content field.
...
func (o *CollectionOfMerchantOrderResponse) SetRequestIdNil() {
	o.RequestId.Set(nil)
}
...
func (o *CollectionOfMerchantOrderResponse) SetLogIdNil() {
	o.LogId.Set(nil)
}
...
func (o *CollectionOfMerchantOrderResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o *CollectionOfMerchantOrderResponse) SetExceptionTypeNil() {
...
func (o CollectionOfMerchantOrderResponse) MarshalJSON() ([]byte, error) {
...
func (o CollectionOfMerchantOrderResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCollectionOfMerchantOrderResponse struct {
	value *CollectionOfMerchantOrderResponse
	isSet bool
}

func (v NullableCollectionOfMerchantOrderResponse) Get() *CollectionOfMerchantOrderResponse {
	return v.value
}

func (v *NullableCollectionOfMerchantOrderResponse) Set(val *CollectionOfMerchantOrderResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionOfMerchantOrderResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionOfMerchantOrderResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionOfMerchantOrderResponse(val *CollectionOfMerchantOrderResponse) *NullableCollectionOfMerchantOrderResponse {
	return &NullableCollectionOfMerchantOrderResponse{value: val, isSet: true}
}

func (v NullableCollectionOfMerchantOrderResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionOfMerchantOrderResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
