...
// checks if the IVendorParty type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IVendorParty{}

// IVendorParty struct for IVendorParty
type IVendorParty struct {
...
func (o *IVendorParty) SetPartyIdNil() {
	o.PartyId.Set(nil)
}
...
func (o *IVendorParty) SetTaxRegistrationNoNil() {
...
func (o *IVendorParty) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *IVendorParty) SetAddressLine1Nil() {
...
func (o *IVendorParty) SetAddressLine2Nil() {
...
func (o *IVendorParty) SetAddressLine3Nil() {
...
func (o *IVendorParty) SetCityNil() {
	o.City.Set(nil)
}
...
func (o *IVendorParty) SetCountyNil() {
	o.County.Set(nil)
}
...
func (o *IVendorParty) SetDistrictNil() {
	o.District.Set(nil)
}
...
func (o *IVendorParty) GetStateOrRegion() string {
...
func (o *IVendorParty) SetStateOrRegionNil() {
...
func (o *IVendorParty) SetPostalCodeNil() {
...
func (o *IVendorParty) SetCountryCodeNil() {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *IVendorParty) GetPhoneOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *IVendorParty) SetPhoneNil() {
	o.Phone.Set(nil)
}
...
func (o IVendorParty) MarshalJSON() ([]byte, error) {
...
func (o IVendorParty) ToMap() (map[string]interface{}, error) {
...
type NullableIVendorParty struct {
	value *IVendorParty
	isSet bool
}

func (v NullableIVendorParty) Get() *IVendorParty {
	return v.value
}

func (v *NullableIVendorParty) Set(val *IVendorParty) {
	v.value = val
	v.isSet = true
}

func (v NullableIVendorParty) IsSet() bool {
	return v.isSet
}

func (v *NullableIVendorParty) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIVendorParty(val *IVendorParty) *NullableIVendorParty {
	return &NullableIVendorParty{value: val, isSet: true}
}

func (v NullableIVendorParty) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIVendorParty) UnmarshalJSON(src []byte) error {
	v.isSet = true
