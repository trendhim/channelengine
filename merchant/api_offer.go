...
func (r OfferAPIOfferStockUpdateRequest) Execute() (*SingleOfStockUpdateResponse, *http.Response, error) {
...
// Execute executes the request
//  @return SingleOfStockUpdateResponse
func (a *OfferAPIService) OfferStockUpdateExecute(r OfferAPIOfferStockUpdateRequest) (*SingleOfStockUpdateResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SingleOfStockUpdateResponse
	)
